...
//
//     const [timeLeft, setTimeLeft] = useState(1 * 30); // 60 minutes
...
//           <textarea
//               value={currentTask === 1 ? task1 : task2}
//               onChange={(e) =>
//                   currentTask === 1 ? setTask1(e.target.value) : setTask2(e.target.value)
//               }
//               spellCheck={"false"}
...
//           />
//                     <div className="mt-2 text-right text-sm">Word Count: {currentTask === 1 ? wordCount(task1) : wordCount(task2)}</div>
//                 </div>
//             </div>
//
//             {/* Footer */}
